const aries = {
    ...
    AttractWoman:
        "Aries women are fearless and natural leaders.They are energetic, charismatic, dynamic, and in love with challenges and adventures.If you want to attract the attention of an Aries woman, you must let her seduce you and appeal to her independent nature.A woman born under the Aries zodiac sign is extremely passionate and romantic, which makes her irresistible to the opposite sex.She is constantly on the move and will never allow herself to be overrun by a man, at the same time craving for love but trying to hold on to control.",
    Myth: {
        one: "The ram with the Golden Fleece was conceived in an unusual way.Poseidon, the god of the sea, turned a nymph into a sheep, so he would distance her from many suitors she had. In order to have relations with her, he had to turn himself into a ram and as a result, the nymph gave birth to a ram with the Golden Fleece.",
...
const gemini = {
    ...
    Myth: {
        one: "The myth of Gemini is a myth of Castor and Pollux, sons of Zeus and Leda. Leda was the wife of Tyndareus, king of Sparta. One of the versions of this myth states that Leda got seduced by Zeus disguised as a swan, on the same night when she shared a bed with her husband. As a result, she hatched two eggs from which four children were born, mortal and immortal for they have different fathers, and among them - Castor and Pollux.",
...
const scorpio = {
    ...
    Myth: {
        ...
        three: "If we want to understand the sign of Scorpio, we have to understand that there is also a romantic side of the myth, in which Orion is seduced by the goddess of the dawn Eos, abducted by her as many other young men were. This made Artemis jealous and out of anger she sent the scorpion to sting Orion, once again."
    },
    CompatibleSigns: {
        one: {
            Zodiac: "Taurus",
...
const aquarius = {
    ...
    AttractWoman:
        "She is independent, mysterious, free-spirited and eccentric, with a fine sense of humor and a strange inability to stay consistent and present. She seems cold and aloof but needs someone to romance her senseless and to share a good conversations with. Truly exciting, this is a woman who makes an excellent partner in emotional, romantic, and especially mental issues, but her dedication might not hold her for very long if she feels even an ounce of disrespect along the way. She is drawn to people who stand out from the crown and needs someone to build her trust and take her by the hand and into better circumstances.",
    Myth: {
        ...
        two: "Ganymede was the most beautiful boy of that time, who was abducted by the gods because of his beauty and taken to Mount Olympus where he replaced Hebe as Zeus' a cupbearer. There is a version of the myth in which Hebe lost her job when she tripped and fell over while doing her job. However, she was replaced by a young, beautiful man, presumed to be Zeus' lover and protégé. Hebe was Hera's daughter and the supreme goddess got angry because of this replacement. Because of constant fighting, frustrated Zeus simply put Ganymede into the stars.",
