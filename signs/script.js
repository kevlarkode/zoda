     ...
     <h2 class="sign">${info.Zodiac}</h2>
        ...
        <div class="content">
            ...
            <div class="attrct-div">
                ...
                <h3>Ophiuchus Love and Romance:</h3>

                <p>${info.LoveAndRomance}</p>
...
`;
        ...
        if (info.Sign === "ophiuchus") {
            r.style.setProperty("--theme-color-1", "hsl(70, 100%, 32%)");
            r.style.setProperty("--theme-color-4", "hsl(100, 90%, 74%)");
            selectionTextColor.href = "./css/text-selection-sapgreen.css";
        }
